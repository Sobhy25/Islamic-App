...
public class Ayah {
    ...
    public void setSora_name_en(@NonNull String sora_name_en) {
    ...
    public void setSora_name_ar(@NonNull String sora_name_ar) {
    ...
    public void setAya_text_emlaey(@NonNull String aya_text_emlaey) {
