...
public class SoraRVAdapter extends RecyclerView.Adapter<SoraRVAdapter.SoraViewHolder> {
    ...
    public SoraViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        SoraViewHolder viewHolder = new SoraViewHolder(v);
        return viewHolder;
    }
    ...
    public void onBindViewHolder(@NonNull SoraViewHolder holder, int position) {
        ...
        holder.nameOfSora.setText(Sora.getArabicName());
        holder.numberOfItsAyat.setText("آياتها: "+Integer.toString(Sora.getNumbersOfAyat()));
        holder.startPage.setText("صفحة: "+Integer.toString(Sora.getStartPage()));
